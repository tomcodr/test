...
<script>
  ...
  export default defineComponent({
    ...
    components: { SideBoardMenu, PortalPopup, MesswerteDropdown, OelTemperaturAnzeige, WasserTemperaturAnzeige, ChartOel },
    methods: {
      openSideBoardMenu() {
